...
public class DuvidasTurmaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSwipeRefreshLayout = (SwipeRefreshLayout) rootView.findViewById(R.id.swipeRefresh_turma);
    ...
    private void getDuvidas( final boolean progress){
        ...
        String url = "http://172.20.10.4:8080/monitoria/api/duvida/disciplina/"+disciplina+"/"+ Dados.getPerfil().getPessoa().getId();
