...
public class DuvidasGeralFragment extends Fragment {
    ...
    private void initDataset() {
        ...
        for (int i = 0; i < DATASET_COUNT; i++) {
            mDataset.add(new Duvida(nomes[i%10], fotosUsuario[i%6], disciplinas[i%4], fotos[i%6], titulos[i%6], descricoes[i%3], curtidas[i%20],  respostas[i%20], status[i%5], dataCriacao[i%4] ));
        }
    }
